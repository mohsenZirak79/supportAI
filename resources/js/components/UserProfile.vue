<template>
    <div class="profile-app" :dir="direction">
        <!-- Header -->
        <header class="profile-header">
            <div class="header-content">
                <div class="header-left">
                    <div class="profile-logo">
                        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M35,70 Q50,55 65,70 L65,100 L35,100 Z" fill="rgba(255,255,255,0.4)"/>
                        </svg>
                    </div>
                ...
                <div class="header-actions">
                    ...
                    <button @click="goToTickets" class="nav-btn ghost" type="button">
                        {{ t('nav.tickets') }}
                    </button>
                    <button
...
.profile-app {
    min-height: 100vh;
    background: linear-gradient(135deg, #0c1220 0%, #1a1f35 50%, #0f172a 100%);
...
.btn-primary:hover:not(:disabled) {
    background: linear-gradient(135deg, #0c6580, #05a5c1);
    transform: translateY(-2px);
